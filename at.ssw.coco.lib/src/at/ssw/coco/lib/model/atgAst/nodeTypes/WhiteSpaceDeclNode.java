...
/**
 * implements an ATG-AST-Node for WhiteSpaceDecl
 * 
 * @author Martin Preinfalk <martin.preinfalk@students.jku.at>
 *
 */
public class WhiteSpaceDeclNode extends AbstractAtgAstNode {
	 ...
	 */
	public WhiteSpaceDeclNode(int offset) {
		super(offset);
		this.setNode = null;
	}
