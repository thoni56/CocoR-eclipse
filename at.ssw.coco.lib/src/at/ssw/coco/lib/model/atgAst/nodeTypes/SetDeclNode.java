...
/**
 * implements an ATG-AST-Node for SetDecl
 * 
 * @author Martin Preinfalk <martin.preinfalk@students.jku.at>
 *
 */
public class SetDeclNode extends AbstractAtgAstNode {
	 ...
	 */
	public void setIdentNode(IdentNode ident) {
	...
	public void accept(AtgAstVisitor atgAstVisitor) {
		...
		if (visitChildren) {
			...
			if (setNode != null) setNode.accept(atgAstVisitor);
		}
	}
}
