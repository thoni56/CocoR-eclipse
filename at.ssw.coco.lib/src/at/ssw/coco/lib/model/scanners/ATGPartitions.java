...
public class ATGPartitions {
	...
	private static String[] LEGAL_CONTENT_TYPES = {
		...
		SINGLE_LINE_COMMENT_IMPORTS,
		MULTI_LINE_COMMENT_IMPORTS,
		STRING_IMPORTS,
		CHARACTER_IMPORTS,
		
		SINGLE_LINE_COMMENT_IGNORECASE_SEGMENT,
		MULTI_LINE_COMMENT_IGNORECASE_SEGMENT,
		STRING_IGNORECASE_SEGMENT,
		CHARACTER_IGNORECASE_SEGMENT,
		
		SINGLE_LINE_COMMENT_CHARACTERS_SEGMENT,
		MULTI_LINE_COMMENT_CHARACTERS_SEGMENT,
		STRING_CHARACTERS_SEGMENT,
		CHARACTER_CHARACTERS_SEGMENT,
		
		SINGLE_LINE_COMMENT_TOKENS_SEGMENT,
		MULTI_LINE_COMMENT_TOKENS_SEGMENT,
		STRING_TOKENS_SEGMENT,
		CHARACTER_TOKENS_SEGMENT,
		
		SINGLE_LINE_COMMENT_PRAGMAS_SEGMENT,
		MULTI_LINE_COMMENT_PRAGMAS_SEGMENT,
		STRING_PRAGMAS_SEGMENT,
		CHARACTER_PRAGMAS_SEGMENT,
		
		SINGLE_LINE_COMMENT_COMMENTS_SEGMENT,
		MULTI_LINE_COMMENT_COMMENTS_SEGMENT,
		STRING_COMMENTS_SEGMENT,
		CHARACTER_COMMENTS_SEGMENT,
		
		SINGLE_LINE_COMMENT_IGNORE_SEGMENT,
		MULTI_LINE_COMMENT_IGNORE_SEGMENT,
		STRING_IGNORE_SEGMENT,
		CHARACTER_IGNORE_SEGMENT,
		
		SINGLE_LINE_COMMENT_PRODUCTIONS_SEGMENT,
		MULTI_LINE_COMMENT_PRODUCTIONS_SEGMENT,
		STRING_PRODUCTIONS_SEGMENT,
		CHARACTER_PRODUCTIONS_SEGMENT,
		
		SINGLE_LINE_COMMENT_PARSER_CODE,
		MULTI_LINE_COMMENT_PARSER_CODE,
		STRING_PARSER_CODE,
		CHARACTER_PARSER_CODE,
	
		SINGLE_LINE_COMMENT_INLINE_CODE,
		MULTI_LINE_COMMENT_INLINE_CODE,
		STRING_INLINE_CODE,
		CHARACTER_INLINE_CODE,
		
		SINGLE_LINE_COMMENT_PRAGMAS_INLINE_CODE,
		MULTI_LINE_COMMENT_PRAGMAS_INLINE_CODE,
		STRING_PRAGMAS_INLINE_CODE,
		CHARACTER_PRAGMAS_INLINE_CODE,
		
		SINGLE_LINE_COMMENT_PRODUCTIONS_INLINE_CODE,
		MULTI_LINE_COMMENT_PRODUCTIONS_INLINE_CODE,
		STRING_PRODUCTIONS_INLINE_CODE,
		CHARACTER_PRODUCTIONS_INLINE_CODE,
		
		SINGLE_LINE_COMMENT_COMPILER_IDENT,
		MULTI_LINE_COMMENT_COMPILER_IDENT,

		
		PRAGMAS_INLINE_CODE,
		PRODUCTIONS_INLINE_CODE,
