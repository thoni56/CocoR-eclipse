	...
	private void storeValues() {
		...
		if (project != null && isCocoProject(project)) {
			try {
				...
				project.setPersistentProperty(Activator.USE_CUSTOM_COCO_OUTPUT_DIR, this.chkCustomOutputDir
						.getSelection() ? "true" : "false");

				project.setPersistentProperty(Activator.CUSTOM_COCO_NAMESPACE, this.txtCustomNamespace.getText());
				project.setPersistentProperty(Activator.USE_CUSTOM_COCO_NAMESPACE, this.chkCustomNamespace
						.getSelection() ? "true" : "false");
