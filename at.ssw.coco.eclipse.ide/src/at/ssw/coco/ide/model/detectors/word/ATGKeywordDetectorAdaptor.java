...
import at.ssw.coco.lib.model.detectors.word.ATGKeywordDetector;

/**
 * This class is an adaptor and is used to inlude and adapt the
 * library functions and methods into CocoEclipse.
 * (at.ssw.coco.lib.model.detectors.word.ATGKeywordDetector)
 * 
 * Implements a <code>IWordDetector</code> to detect ATG keywords.
 *
 ...
 *
 */
public class ATGKeywordDetectorAdaptor implements IWordDetector {
	
	private ATGKeywordDetector detector = new ATGKeywordDetector();
