...
import at.ssw.coco.lib.model.detectors.word.IdentDetector;

/**
 * This class is an adaptor and is used to inlude and adapt the
 * library functions and methods into CocoEclipse.
 * (at.ssw.coco.lib.model.detectors.word.IdentDetector)
 * 
 * Implements an <code>IWordDetector</code> that detects simple idents.
 *
 ...
 *
 */
public class IdentDetectorAdaptor implements IWordDetector {
	
	private IdentDetector detector =  new IdentDetector();
