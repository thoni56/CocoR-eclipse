...
/**
 * implements Refactoring for Renaming ATG pragmas
 * 
 * @author Martin Preinfalk <martin.preinfalk@students.jku.at>
 * 
 */
public class RenamePragmaRefactoring extends AbstractAtgRefactoring {
	 ...
	 */
	public RenamePragmaRefactoring(RenameRefactorInfo info) {
		super(info);
		this.info = info;
	}
	...
	public String getName() {
		return CoreTexts.renamePragmaRefactor_name;
	}
