...
/**
 * implements Refactoring for Renaming ATG productions
 * 
 * @author Martin Preinfalk <martin.preinfalk@students.jku.at>
 * 
 */
public class RenameProductionRefactoring extends AbstractAtgRefactoring {
	 ...
	 */
	public RenameProductionRefactoring(RenameRefactorInfo info) {
		super(info);
		this.info = info;
	}
	...
	public String getName() {
		return CoreTexts.renameProductionRefactor_name;
	}
